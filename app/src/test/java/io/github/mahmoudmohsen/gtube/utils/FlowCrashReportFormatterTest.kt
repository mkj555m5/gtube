            ...
            FlowCrashReportSnapshot(
                ...
                stackTrace = """
                    java.lang.OutOfMemoryError: Failed to allocate
                        at io.github.mahmoudmohsen.gtube.player.PlayerCacheManager.updateCache(PlayerCacheManager.kt:42)
                        at io.github.mahmoudmohsen.gtube.service.VideoPlayerService.onStartCommand(VideoPlayerService.kt:121)
