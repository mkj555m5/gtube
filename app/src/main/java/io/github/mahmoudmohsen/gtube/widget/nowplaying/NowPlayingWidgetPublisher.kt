...
import io.github.mahmoudmohsen.gtube.widget.core.markNowPlayingStopped
import io.github.mahmoudmohsen.gtube.widget.core.writeNowPlayingSnapshot
...
class NowPlayingWidgetPublisher @Inject constructor(
    ...
    private suspend fun updatePlayerWidgets() {
        ...
        io.github.mahmoudmohsen.gtube.widget.turntable.TurntableWidget().updateAll(context)
    }
}
