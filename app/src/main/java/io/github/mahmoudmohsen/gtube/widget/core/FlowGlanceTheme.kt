...
/**
 * Theme wrapper for all gtube widgets. [colors] comes from [widgetColorsFlow], so every
...
/**
 * Standard root surface for every gtube widget: theme surface color + the launcher's
