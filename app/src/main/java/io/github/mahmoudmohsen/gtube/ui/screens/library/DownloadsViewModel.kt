...
import io.github.mahmoudmohsen.gtube.data.video.downloader.FlowDownloadService
...
class DownloadsViewModel @Inject constructor(
            ...
            combine(
                ...
                val incomplete = downloads.filter { download ->
                    download.download.videoId !in pending &&
                        download.overallStatus != io.github.mahmoudmohsen.gtube.data.local.entity.DownloadItemStatus.COMPLETED
                }
    ...
    fun deleteVideoDownload(videoId: String) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            if (download?.overallStatus != io.github.mahmoudmohsen.gtube.data.local.entity.DownloadItemStatus.COMPLETED) {
    ...
    fun removeIncompleteDownloads() {
        viewModelScope.launch(Dispatchers.IO) {
            val ids = videoDownloadManager.allDownloads.first()
                .filter { it.overallStatus != io.github.mahmoudmohsen.gtube.data.local.entity.DownloadItemStatus.COMPLETED }
