...
import io.github.mahmoudmohsen.gtube.data.local.QueuePersistence
import io.github.mahmoudmohsen.gtube.service.Media3MusicService
...
import io.github.mahmoudmohsen.gtube.data.local.AudioSettingsPersistence
...
object EnhancedMusicPlayerManager {
    ...
    suspend fun resolveStreamUrl(videoId: String): String? {
        ...
        return try {
             val playbackData = io.github.mahmoudmohsen.gtube.utils.MusicPlayerUtils.playerResponseForPlayback(videoId).getOrNull()
    ...
    private fun setupPlayerListener(controller: Player) {
        controller.addListener(object : Player.Listener {
            ...
            override fun onPlayerError(error: androidx.media3.common.PlaybackException) {
                ...
                showPlaybackWarning(
                    appContext?.getString(io.github.mahmoudmohsen.gtube.R.string.music_playback_warning_generic)
    ...
    private fun applyEqProfile(profile: io.github.mahmoudmohsen.gtube.data.model.ParametricEQ) {
        try {
            val json = Json.encodeToString(io.github.mahmoudmohsen.gtube.data.model.ParametricEQ.serializer(), profile)
