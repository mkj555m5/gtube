...
import io.github.mahmoudmohsen.gtube.ui.components.FlowLiveChatBottomSheet
import io.github.mahmoudmohsen.gtube.ui.components.FlowPlaylistQueueBottomSheet
...
fun PlayerBottomSheetsContainer(
    ...
    LaunchedEffect(Unit) {
        ...
        SleepTimerManager.attachExitCallback {
            ...
            context.stopService(
                android.content.Intent(context, io.github.mahmoudmohsen.gtube.service.VideoPlayerService::class.java),
            )
            context.stopService(
