...
fun HomeScreen(
    ...
    onShortClick: (io.github.mahmoudmohsen.gtube.data.shorts.queue.ShortsQueueSource) -> Unit,
    onSearchClick: () -> Unit,
    ...
    val homeViewMode by preferences.homeViewMode.collectAsStateWithLifecycle(
        initialValue = io.github.mahmoudmohsen.gtube.data.local.HomeViewMode.GRID,
    )
    ...
    Scaffold(
        ...
        ResettableHomePullToRefreshBox(
            ...
            BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
                val isListView = homeViewMode == io.github.mahmoudmohsen.gtube.data.local.HomeViewMode.LIST
