...
import io.github.mahmoudmohsen.gtube.network.AppProxyConfig
import io.github.mahmoudmohsen.gtube.network.AppProxyType
...
class PlayerPreferences(
    ...
    private object Keys {
        ...
        // Deep gtube (Incognito / No-Engine) mode
    ...
    // gtube for reading the stored SB User ID (may be null)
