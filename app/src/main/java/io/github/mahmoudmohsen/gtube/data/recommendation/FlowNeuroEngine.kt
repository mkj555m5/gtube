 ...
 *
 * gtube is free software: you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, version 3 of the License.
 *
 * This recommendation algorithm (FlowNeuroEngine) is the intellectual property
 * of the gtube project. Any use of this code in other projects must
 * explicitly credit "gtube Android Client" and link back to the original repository.
 */
...
/**
 * gtube Neuro Engine (V10.0 — Channel Intelligence + Shorts Vector + Anti-Rec + Momentum)
 *
...
class FlowNeuroEngine(private val appContext: Context) {
    ...
    suspend fun onVideoInteraction(
        ...
        // Deep gtube mode: freeze vector learning while active and not yet expired
