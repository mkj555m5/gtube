...
import io.github.mahmoudmohsen.gtube.data.model.ShortsSequenceResult
...
import io.github.mahmoudmohsen.gtube.player.shorts.ShortsStartupTrace
...
class ShortsRepository private constructor(
    ...
    private suspend fun fetchDiscoveryFeed(): ShortsSequenceResult {
        ...
        suspend fun runDiscovery(): List<io.github.mahmoudmohsen.gtube.data.model.Video>? =
            try {
        ...
        val discoveryVideos: List<io.github.mahmoudmohsen.gtube.data.model.Video> =
     ...
     */
    private fun deduplicateByTitle(videos: List<io.github.mahmoudmohsen.gtube.data.model.Video>): List<io.github.mahmoudmohsen.gtube.data.model.Video> {
        if (videos.size <= 1) return videos

        val result = mutableListOf<io.github.mahmoudmohsen.gtube.data.model.Video>()
        val titleTokens =
            videos.map { video ->
                video to
                    video.title
