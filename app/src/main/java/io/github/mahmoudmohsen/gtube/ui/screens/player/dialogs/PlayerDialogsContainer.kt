package io.github.mahmoudmohsen.gtube.ui.screens.player.dialogs
...
import io.github.mahmoudmohsen.gtube.ui.screens.player.components.*
...
fun PlayerDialogsContainer(
    ...
    if (screenState.showDownloadDialog) {
        when (downloadDialogStyle) {
            io.github.mahmoudmohsen.gtube.data.local.DownloadDialogStyle.COMPACT -> {
            ...
            io.github.mahmoudmohsen.gtube.data.local.DownloadDialogStyle.FULL -> {
    ...
    if (showSettingsSurface && renderSettingsMenu) {
        SettingsMenuDialog(
            ...
            onCastClick = {
                io.github.mahmoudmohsen.gtube.player.dlna.DlnaCastManager
            ...
            onPipClick = {
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O &&
                    ...
                    screenState.showSettingsMenu = false
                    io.github.mahmoudmohsen.gtube.player.PictureInPictureHelper.requestPlayerPipMode(
