...
class NotificationActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_CANCEL_DOWNLOAD = "io.github.mahmoudmohsen.gtube.action.CANCEL_DOWNLOAD"
        const val ACTION_RETRY_DOWNLOAD = "io.github.mahmoudmohsen.gtube.action.RETRY_DOWNLOAD"
        const val ACTION_PAUSE_DOWNLOAD = "io.github.mahmoudmohsen.gtube.action.PAUSE_DOWNLOAD"
        const val ACTION_RESUME_DOWNLOAD = "io.github.mahmoudmohsen.gtube.action.RESUME_DOWNLOAD"
        const val ACTION_DISMISS_NOTIFICATION = "io.github.mahmoudmohsen.gtube.action.DISMISS_NOTIFICATION"
