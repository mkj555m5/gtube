package io.github.mahmoudmohsen.gtube.player.sabr.core
...
import io.github.mahmoudmohsen.gtube.player.sabr.proto.FormatInitializationMetadata
import io.github.mahmoudmohsen.gtube.player.sabr.proto.MediaHeader
import io.github.mahmoudmohsen.gtube.player.sabr.proto.NextRequestPolicy
import io.github.mahmoudmohsen.gtube.player.sabr.proto.PlaybackStartPolicy
import io.github.mahmoudmohsen.gtube.player.sabr.proto.SabrContextUpdate
import io.github.mahmoudmohsen.gtube.player.sabr.proto.SabrContextSendingPolicy
import io.github.mahmoudmohsen.gtube.player.sabr.proto.SabrError
import io.github.mahmoudmohsen.gtube.player.sabr.proto.SabrRedirect
import io.github.mahmoudmohsen.gtube.player.sabr.proto.SabrSeek
import io.github.mahmoudmohsen.gtube.player.sabr.proto.StreamProtectionStatus
import io.github.mahmoudmohsen.gtube.player.sabr.ump.UmpFrame
import io.github.mahmoudmohsen.gtube.player.sabr.ump.UmpFrameDecoder
import io.github.mahmoudmohsen.gtube.player.sabr.ump.UmpPartType
import io.github.mahmoudmohsen.gtube.player.sabr.ump.SabrMediaPayload
...
class SabrStreamController(
    ...
    private suspend fun trackMedialessResponses() {
        ...
        if (consecutiveMedialessResponses >= MAX_MEDIALESS_RESPONSES) {
            ...
            io.github.mahmoudmohsen.gtube.player.error.PlayerDiagnostics.logError(
    ...
    private suspend fun handleReloadRequired(frame: UmpFrame) {
        ...
        val token = try {
            var t: String? = null
            io.github.mahmoudmohsen.gtube.player.sabr.proto.ProtobufReader(frame.payload).forEachField { field ->
                if (field.fieldNumber == 1) {
                    io.github.mahmoudmohsen.gtube.player.sabr.proto.ProtobufReader(field.asBytes()).forEachField { inner ->
        ...
        io.github.mahmoudmohsen.gtube.player.error.PlayerDiagnostics.logWarning(
