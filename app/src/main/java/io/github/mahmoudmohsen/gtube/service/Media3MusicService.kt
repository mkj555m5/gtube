...
import io.github.mahmoudmohsen.gtube.data.model.ParametricEQ
import io.github.mahmoudmohsen.gtube.data.music.YouTubeMusicService
import io.github.mahmoudmohsen.gtube.data.newmusic.InnertubeMusicService
import io.github.mahmoudmohsen.gtube.extensions.setOffloadEnabled
...
import io.github.mahmoudmohsen.gtube.utils.MusicPlayerUtils
...
class Media3MusicService : MediaLibraryService() {
    ...
    @Inject
    lateinit var widgetPublisher: io.github.mahmoudmohsen.gtube.widget.nowplaying.NowPlayingWidgetPublisher
    ...
    override fun onCreate() {
        ...
        lifecycleScope.launch {
            io.github.mahmoudmohsen.gtube.player.EnhancedMusicPlayerManager.isLiked.collectLatest {
                updateNotification()
        ...
        lifecycleScope.launch {
            var lastQuality: io.github.mahmoudmohsen.gtube.data.local.MusicAudioQuality? = null
    ...
    private fun applyMusicQualityChange() {
        ...
        try {
            ...
            io.github.mahmoudmohsen.gtube.player.EnhancedMusicPlayerManager
                .clearUrlCache()
        } catch (e: Exception) {
                        ...
                        if (!videoId.isNullOrBlank() && !title.isNullOrBlank() && !artist.isNullOrBlank()) {
                            lifecycleScope.launch(Dispatchers.IO) {
                                try {
                                    ...
                                    val helper =
                                        io.github.mahmoudmohsen.gtube.data.lyrics
    ...
    private fun initializeSession() {
        val intent =
            Intent(this, MainActivity::class.java).apply {
                action = "io.github.mahmoudmohsen.gtube.action.OPEN_MUSIC_PLAYER"
    ...
    private fun updateNotification() {
        ...
        val isLiked = io.github.mahmoudmohsen.gtube.player.EnhancedMusicPlayerManager.isLiked.value
        ...
        override fun onGetChildren(
            ...
            val items =
                when (parentId) {
                    ...
                    AUTO_QUEUE_ID -> {
                        io.github.mahmoudmohsen.gtube.player.EnhancedMusicPlayerManager.queue.value
                            .map { it.toAutoMediaItem() }
                    }

                    AUTO_CURRENT_ID -> {
                        io.github.mahmoudmohsen.gtube.player.EnhancedMusicPlayerManager.currentTrack.value
    ...
    private fun io.github.mahmoudmohsen.gtube.ui.screens.music.MusicTrack.toAutoMediaItem(): MediaItem {
        val artwork =
            highResThumbnailUrl
    ...
    private fun autoTrackForMediaId(mediaId: String): io.github.mahmoudmohsen.gtube.ui.screens.music.MusicTrack? {
        val manager = io.github.mahmoudmohsen.gtube.player.EnhancedMusicPlayerManager
